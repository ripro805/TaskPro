...
ALLOWED_HOSTS = ['localhost', '127.0.0.1', 'testserver'] if DEBUG else []  # type: ignore[assignment]  # dev allowlist
...
# https://docs.djangoproject.com/en/6.0/ref/settings/#databases
#
# Reads DATABASE_URL and parses it into DATABASES. Falls back to local sqlite3.
